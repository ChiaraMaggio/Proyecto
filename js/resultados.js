                ...
                document.querySelector(".contenedor-géneros").innerHTML += `
                    <article class="artículo-género">
                        <div>
                            ...
                            <a href="detail-movie.html?id=${datos.results[i].id}"><img id="portadas" src="https://image.tmdb.org/t/p/w200${datos.results[i].poster_path}" alt="Portada de ${datos.results[i].original_title}"></a>
                ...
                document.querySelector(".contenedor-géneros").innerHTML += `
                    <article class="artículo-género">
                        <div>
                            ...
                            <a href="detail-serie.html?id=${datos.results[i].id}"><img id="portadas" src="https://image.tmdb.org/t/p/w200${datos.results[i].poster_path}" alt="Portada de ${datos.results[i].original_name}"></a>
                            <div class="nombre-estreno">
